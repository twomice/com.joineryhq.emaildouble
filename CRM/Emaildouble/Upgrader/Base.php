 ...
 */
class CRM_Emaildouble_Upgrader_Base {

  /**
   * @var CRM_Emaildouble_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Emaildouble_Upgrader(
        'com.joineryhq.emaildouble',
        realpath(__DIR__ . '/../../../')
      );
    }
   ...
   *
   * ```
   * CRM_Emaildouble_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Emaildouble_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
